<template>
  <div>
    <Title>如何提问</Title>
    <v-card class="mx-16 mt-12 px-16 py-4">
      <p class="text-h3 text-center">如何提问</p>
      <div>
        <p class="text-h6">
          先搜索，再提问<br />
          提问前先在
          Google、百度或者社区先行搜索。这样能更快地帮你找到答案。即使没找到，在看了相关或类似的问题之后，你的提问会更准确。
        </p>
        <!--        <client-only>-->
        <v-text-field
          v-model="SearchText"
          ...
          class="my-3"
          single-linelabel="搜索你遇到的问题"
          variant="outlined"
          @click:append-inner="searchQuestion()"
        ...
        <div class="d-answer-tip-recommend">
          ...
          <p class="card-text mdi">多个问题请分别提问</p>
        </div>
        <span class="text-h6 text-red">不该问的</span>
        <div class="d-answer-tip-inappropriate">
          <p class="card-text mdi">别人已经问过的重复问题</p>
          <p class="card-text mdi">没有尝试寻找过答案，直接就问</p>
          <p class="card-text mdi">征询产品、服务推荐</p>
          <p class="card-text mdi">程序评比投票，没有结论的观点讨论</p>
          <p class="card-text mdi">任何与开发无关的问题</p>
        </div>
        ...
        <div class="my-3">
          <v-btn color="#1aad19" size="large" to="/question/ask" variant="tonal"
            >我已知晓，继续提问</v-btn
          >
        </div>
      </div>
