...
export const changeHighlightStyle = async (name: string, ssr?: boolean) => {
  ...
  switch (name) {
    ...
    case 'base16atelierLakesideLight':
      css = await import('~~/constant/highlightCJs/base16/atelierLakesideLight')
      break
    ...
    case 'base16atelierSulphurpoolLight':
      css = await import('~~/constant/highlightCJs/base16/atelierSulphurpoolLight')
      break
    ...
    case 'base16blackMetalDarkFuneral':
      css = await import('~~/constant/highlightCJs/base16/blackMetalDarkFuneral')
      break
    ...
    case 'base16equilibriumGrayLight':
      css = await import('~~/constant/highlightCJs/base16/equilibriumGrayLight')
      break
    ...
    case 'base16synthMidnightTerminalDark':
      css = await import('~~/constant/highlightCJs/base16/synthMidnightTerminalDark')
      break
    case 'base16synthMidnightTerminalLight':
      css = await import('~~/constant/highlightCJs/base16/synthMidnightTerminalLight')
      break
    case 'base16tango':
    ...
    case 'base16windowsHighContrastLight':
      css = await import('~~/constant/highlightCJs/base16/windowsHighContrastLight')
      break
