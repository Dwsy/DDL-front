...
:root {
  --text-color: #f6f7ee;
  --bg-color: #111c2a;
  --side-bar-bg-color: #111c2a;
  --active-file-bg-color: #111c2a;
  --rawblock-edit-panel-bd: #172134;
  --window-border: 0 solid #111c2a;
  --control-text-color: #f6f7ee;
  --primary-color: #f9b537;
  --primary-btn-border-color: #f9b537;
  --active-file-border-color: #f9b537;
  --primary-btn-text-color: #f9b537;
  --item-hover-text-color: #f9b537;
  --meta-content-color: #f9b537;
  --search-select-text-color: #f9b537;
  --heading-char-color: #f9b537;
  /* Mermaid diagrams*/
  --mermaid-theme: dark;
}
...
.markdown-body u {
  ...
  background-image: linear-gradient(to bottom, rgba(0, 0, 0, 0) 50%, #f9b537 50%);
...
.markdown-body hr {
  ...
  background-image: linear-gradient(90deg, #2d4562, #2d4562);
