...
:root {
  --text-color: #dce3e8;
  --bg-color: #222e33;
  --side-bar-bg-color: #222e33;
  --active-file-bg-color: #222e33;
  --rawblock-edit-panel-bd: #12181b;
  --window-border: 0 solid #222e33;
  --control-text-color: #dce3e8;
  --primary-color: #c7bf7f;
  --primary-btn-border-color: #c7bf7f;
  --active-file-border-color: #c7bf7f;
  --primary-btn-text-color: #c7bf7f;
  --item-hover-text-color: #c7bf7f;
  --meta-content-color: #c7bf7f;
  --search-select-text-color: #c7bf7f;
  --heading-char-color: #c7bf7f;
  /* Mermaid diagrams*/
  --mermaid-theme: dark;
}
...
.markdown-body u {
  ...
  background-image: linear-gradient(to bottom, rgba(0, 0, 0, 0) 50%, #c7bf7f 50%);
...
.markdown-body hr {
  ...
  background-image: linear-gradient(90deg, #0f1517, #0f1517);
