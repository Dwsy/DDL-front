...
export const useAxiosGetQaInvitationAnswerNotify = (page: number) => {
  return useGet<ResponseData<PageData<NotifyMsg>>>('message/notify/qa/invitationAnswer', { page })
}

export const useAxiosGetQaAcceptedAnswerNotify = (page: number) => {
  return useGet<ResponseData<PageData<NotifyMsg>>>('message/notify/qa/accepted', { page })
}
